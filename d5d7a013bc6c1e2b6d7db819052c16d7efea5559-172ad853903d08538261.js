      ...
      e.exports = (function e(t) {
        ...
        function K(e, t, a, o, i) {
          for (
            ...
            if (
              ...
              if (
                _ === ae &&
                (I > 0 && (ie = ie.replace(r, "")), ie.trim().length > 0)
              ) {
                switch (g) {
                  case 32:
                  case 9:
              ...
              switch (g) {
                case 123:
                  for (
                    b = (ie = ie.trim()).charCodeAt(0), S = 1, q = ++_;
                    _ < J;
                ...
                case 59:
                  if (
                    ...
                    switch (
                      ...
                      z > 0 &&
                        void 0 !==
                          (s = ne(1, ie, t, e, R, x, se.length, o, i, o)) &&
              ...
              case 10:
                ...
                47 === p
                  ...
                  : j + O === 0 &&
                    ...
                    ie.length > 0 &&
                    ((I = 1), (ie += "\0")),
                  z * $ > 0 && ne(0, ie, t, e, R, x, se.length, o, i, o),
                  (x = 1),
                  R++;
                break;
              case 59:
            ...
            if (
              ((c =
                0 === j && 107 !== o
                  ...
                  : t),
              z > 0 &&
                void 0 !== (s = ne(2, se, c, e, R, x, q, o, i, o)) &&
                0 === (se = s).length)
            )
              return le + se + ue;
        ...
        function Q(e, t, n, r) {
          ...
          switch (f) {
            ...
            case 932:
              if (45 === p.charCodeAt(4))
                switch (p.charCodeAt(5)) {
                  ...
                  case 115:
                    return M + p + I + p.replace("shrink", "negative") + p;
                  case 98:
                    return M + p + I + p.replace("basis", "preferred-size") + p;
                }
              return M + p + I + p + p;
            case 964:
              return M + p + I + "flex-" + p + p;
            case 1023:
              ...
              return (
                ...
                M + "box-pack" + u + M + p + I + "flex-pack" + u + p
              );
            case 1005:
              return o.test(p)
              ...
              if (45 === p.charCodeAt(5))
                switch (p.charCodeAt(6)) {
                  case 105:
                    return (
                      (u = p.replace("-items", "")),
                      M + p + M + "box-" + u + I + "flex-" + u + p
                    );
                  case 115:
                    return M + p + I + "flex-item-" + p.replace(S, "") + p;
                  default:
                    return (
                      M +
                      p +
            ...
            case 953:
              if (!0 === k.test(e))
                return 115 ===
                  ...
                  ? Q(e.replace("stretch", "fill-available"), t, n, r).replace(
                      ":fill-available",
                      ":stretch"
                    )
                  : p.replace(u, M + u) +
            ...
            case 962:
              if (
                ((p = M + p + (102 === p.charCodeAt(5) ? I + p : "") + p),
                n + r === 211 &&
                  105 === p.charCodeAt(13) &&
        ...
        function te(e, t) {
          var n = Q(t, t.charCodeAt(0), t.charCodeAt(1), t.charCodeAt(2));
          return n !== t + ";"
        ...
        function oe(t, n) {
          ...
          o < 33 && (o = (a = a.trim()).charCodeAt(0)),
            Y > 0 && (W = a.replace(d, 91 === o ? "" : "-")),
            (o = 1),
            1 === j ? (V = a) : (X = a);
          var i,
            c = [V];
          z > 0 &&
            void 0 !== (i = ne(-1, n, c, c, R, x, 0, 0, 0, 0)) &&
            "string" == typeof i &&
            (n = i);
          var s = K(B, c, n, 0, 0);
          return (
            z > 0 &&
              void 0 !== (i = ne(-2, s, c, c, R, x, s.length, 0, 0, 0)) &&
              "string" != typeof (s = i) &&
              (o = 0),
            (W = ""),
            (V = ""),
            ...
            o.a.createElement(m, {
              ...
              menu: o.a.createElement(
                ...
                o.a.createElement(
                  ...
                  o.a.createElement(
                    "a",
                    { href: "https://www.youtube.com/watch?v=ZPDpcYEdiOg" },
                    "Home"
                  )
                ),
                o.a.createElement(
    ...
    fMHQ: function(e, t, n) {
      ...
      (function(e) {
        ...
        var h,
          ...
          B = (function(e) {
            function t() {
              return k(this, t), x(this, e.apply(this, arguments));
            }
            return (
              _(t, e),
          ...
          z = (function() {
            ...
            return (
              ...
              (e.prototype.getStyleTags = function() {
                return (
                  this.closed ||
                    (H.splice(H.indexOf(this.instance), 1), (this.closed = !0)),
        ...
        (ae.childContextTypes = (((Q = {})[te] = l.a.func), (Q[ne] = re), Q)),
                  ...
                  (this.isStatic =
                    ...
                    (function e(t, n) {
                      for (var r = 0; r < t.length; r += 1) {
                        ...
                        if ("function" == typeof a && !W(a)) return !1;
                      }
                      if (void 0 !== n)
                        for (var o in n) {
          ...
          me = (function(e, t) {
              ...
              r = (function(e) {
                function t() {
                  ...
                  for (
                    ...
                    o[i] = arguments[i];
                  return (
                    (n = r = x(this, e.call.apply(e, [this].concat(o)))),
                    (r.attrs = {}),
            ...
            return function a(o, i, c) {
              var s,
                ...
                v = (function(e) {
                  function n() {
                    return k(this, n), x(this, e.apply(this, arguments));
                  }
                  return (
                    _(n, e),
        ...
        var u,
          ...
          C = function(e, t) {
            var n = e.baseTag,
              ...
              f = e.title,
              d = e.titleAttributes;
            O(c.TAG_NAMES.BODY, r), O(c.TAG_NAMES.HTML, a), S(f, d);
            var h = {
...
//# sourceMappingURL=d5d7a013bc6c1e2b6d7db819052c16d7efea5559-172ad853903d08538261.js.map
